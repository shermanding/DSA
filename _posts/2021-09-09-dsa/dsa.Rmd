...
description: |
  We use popular R packages to visualize static data through histograms.
author:
  - name: Sherman Ding
...
When multivariate data are used, the correlation coefficients of the pair comparisons are displayed in a table form known as correlation matrix or scatter-plot matrix.  
